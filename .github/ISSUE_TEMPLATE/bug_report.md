...
- [ ] I have searched [existing issues](https://github.com/ledgerleaf/ledgerleaf/issues?q=is:issue) and [discussions](https://github.com/ledgerleaf/ledgerleaf/discussions) to ensure this is not a duplicate issue
    
### How are you using LedgerLeaf?

- [ ] I am a paying LedgerLeaf customer (hosted version)
  - Paying LedgerLeaf users can also open requests in Intercom (if there is sensitive info involved)
...
- Self hosted app commit SHA (find in user menu): [enter commit sha here]
  - [ ] I have confirmed that my app's commit is the latest version of LedgerLeaf
...
Be as specific as possible so LedgerLeaf maintainers can quickly reproduce the bug you're experiencing.
