class Demo::Generator
  ...
  def generate_empty_data!(skip_clear: false)
    with_timing(__method__) do
      ...
      create_family_and_users!("Demo Family", "user@ledgerleaf.local", onboarded: true, subscribed: true)
  ...
  def generate_new_user_data!(skip_clear: false)
    with_timing(__method__) do
      ...
      create_family_and_users!("Demo Family", "user@ledgerleaf.local", onboarded: false, subscribed: false)
  ...
  def generate_default_data!(skip_clear: false, email: "user@ledgerleaf.local")
    if skip_clear
