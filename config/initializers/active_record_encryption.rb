...
# Skip credentials check entirely if RAILS_SKIP_CREDENTIALS is set
credentials_available = false
if ENV["RAILS_SKIP_CREDENTIALS"] != "true"
  credentials_available = begin
...
if Rails.application.config.app_mode.self_hosted? && !credentials_available
